...
void preguntar_canal_tv(char* canal_tv){
	...
	printf("\n\nVas a ver televisión un rato, pones el canal de Anime (%c), Musica Pop (%c) o Limpieza (%c): ", ANIME, MUSICA_POP, LIMPIEZA);
	scanf(" %c", canal_tv);
...
void mostrar_personalidad_escandalosa (int piso_torre,int fuerza_grito,char canal,char alimento) {
	...
	printf("\n ---------- Después de un arduo análisis , se determinó que la personalidad más adecuada para definirte es ------------ \n\n");
